...
allowed-tools: mcp__mercury-market-data__get_regime, mcp__mercury-market-data__get_curve_snapshot, mcp__mercury-market-data__get_curve_analysis, mcp__mercury-market-data__get_treasuries_bundle, mcp__mercury-market-data__get_stir_bundle, mcp__mercury-market-data__get_stir_snapshot, mcp__mercury-market-data__get_stir_matrix, mcp__mercury-market-data__get_futures_options, mcp__mercury-econ-data__get_economic_events, mcp__mercury-pubfinance__get_lci_summary, mcp__mercury-pubfinance__get_fed_liquidity_summary, mcp__mercury-darth-feedor__get_squawk_context, AskUserQuestion
priority: high
---
...
```
get_squawk_context(view="topic:treasuries yields rates")
```
