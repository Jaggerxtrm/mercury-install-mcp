...
This project is indexed by GitNexus as **terminalbeta** (101 symbols, 119 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/terminalbeta/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/terminalbeta/context` | Codebase overview, check index freshness |
| `gitnexus://repo/terminalbeta/clusters` | All functional areas |
| `gitnexus://repo/terminalbeta/processes` | All execution flows |
| `gitnexus://repo/terminalbeta/process/{name}` | Step-by-step execution trace |
